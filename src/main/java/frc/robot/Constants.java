...
public final class Constants {
  ...
  public static final Map<ScoreTypeIdentifier, List<ScoreStep>> SCORE_STEP_MAP =
      Map.of(
          ...
          List.of(
              new ScoreStep(new ArmState(24, 5)).canWaitHere(),
          ...
          List.of(
              new ScoreStep(new ArmState(70, Arm.Setpoints.Extensions.MIN_EXTENSION)),
              new ScoreStep(new ArmState(70, 2)).canWaitHere(),
              new ScoreStep(OuttakeSubsystem.Modes.OUTTAKE),
              new ScoreStep(new ArmState(70, Arm.Setpoints.Extensions.MIN_EXTENSION))),
