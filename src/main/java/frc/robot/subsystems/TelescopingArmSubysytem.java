...
public class TelescopingArmSubysytem extends SubsystemBase {
  ...
  public TelescopingArmSubysytem() {
    ...
    motor.configForwardSoftLimitThreshold(
        heightToTicks(TelescopingArm.MAX_EXTENSION), 100); // this is the top limit
    motor.configReverseSoftLimitThreshold(
        heightToTicks(TelescopingArm.MIN_EXTENSION), 100); // this is the bottom limit

    motor.configForwardSoftLimitEnable(true, 100);
    motor.configReverseSoftLimitEnable(true, 100);
