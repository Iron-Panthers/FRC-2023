...
public class VibrateControllerCommand extends CommandBase {
  ...
  public VibrateControllerCommand(
      CommandXboxController controller, double duration, double strength) {
  ...
  public void initialize() {
    ...
    controller.getHID().setRumble(RumbleType.kRightRumble, strength);
    controller.getHID().setRumble(RumbleType.kLeftRumble, strength);
  }
