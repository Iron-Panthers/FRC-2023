...
public class ShowDriverControlledColor extends InstantCommand {
  private final RGBSubsystem rgbSubsystem;
  private final RGBColor color;
  private final double maxLifetimeSeconds;

  public ShowDriverControlledColor(
      RGBSubsystem rgbSubsystem, RGBColor color, double maxLifetimeSeconds) {
